...
class Database:
    ...
    def set_tournament(self, tournament: str) -> None:
        """
    ...
    def get_match_metadata(self):
        """
        Get match metadata, such as player names and tournament.
        """
    ...
    def _expand_df_fields(self) -> None:
        """
